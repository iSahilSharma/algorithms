...
{
    /// <summary>
    /// Jumping on the Clouds - Emma is playing a new mobile game that starts with consecutively numbered clouds. 
    ...
    /// 4
    ///
    /// Things to Remember: Greedy Algorithm 
    /// </summary>
    static class JumpingOnTheClouds
    {
        public static int Jumps(int[] clouds)
        {
            int numberOfJumps = 0; 
            ...
            int i = 0;
            while (i < length - 1)          //Use while loop if the iteration is inconsistent
            {
